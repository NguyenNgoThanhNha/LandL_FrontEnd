...
import { UpdateUserInfoType } from "@/schemas/userSchema.ts"
import { useForm, SubmitHandler } from "react-hook-form"
import { zodResolver } from "@hookform/resolvers/zod"
import { UpdateUserInfoSchema } from "@/schemas/userSchema.ts"
...
const ProfilePage = () => {
  ...
  if (!auth?.user) return <p><Loading /></p> // Display loading message until auth data is available
