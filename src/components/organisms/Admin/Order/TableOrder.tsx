              ...
              {filteredOrders.length > 0 ? (
                filteredOrders.map((order) => (
                  <TableRow key={order.orderDetailId}>
                    ...
                    <TableCell>
                      {order.transactionDateTime ? new Date(order.transactionDateTime).toLocaleDateString() : 'N/A'}
                    </TableCell>
                    ...
                    <TableCell>
                      <div
                        className={`rounded-full flex px-2 py-1 justify-center text-white hover:bg-opacity-75 ${
